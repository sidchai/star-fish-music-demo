...
<body>
<div class="layui-row">
    <form class="layui-form" action="${pageContext.request.contextPath}/updateSongListInfo.am" method="post" enctype="multipart/form-data" id="my-updateSongList-form" style="width: 400px;height: 400px;padding-top: 20px">
        <div class="layui-form-item">
            <label class="layui-form-label">标题</label>
            <div class="layui-input-block">
                <input type="text" name="title" required  lay-verify="required" autocomplete="off" class="layui-input" value="${SONG_LIST_INFO.title}">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <input type="text" name="style" required  lay-verify="required" autocomplete="off" class="layui-input" value="${SONG_LIST_INFO.style}">
            </div>
        </div>
...
<script>
    //表单验证
    $("#my-updateSongList-form").validate({
        rules: {
            title: {
                required: true
            },
