            ...
            <div class="list-view artist-list-view view-without-leftbar">
                    ...
                    <div class="tabs unselectable">
                        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                            <ul class="layui-tab-title">
                                ...
                                <li class="layui-this"><a href="popularSongList.jsp">流行</a></li>
                            </ul>
                ...
                <div>
                    <div class="list-container">
                        <div class="adaptive-list" id="my-song-list-rap-row" style="opacity: 1">
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function getInfo(){
        $.ajax({
            url: "${pageContext.request.contextPath}/manageSongListByStyle.do?style=" + '流行',
            dataType: "json",
            type: "post",
            async: false,
            data: {
    ...
    function successFu(pager){
        ...
        $("#my-song-list-rap-row").html(html);
    }
    function  toPage() {
