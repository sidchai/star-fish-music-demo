            ...
            <div class="list-view artist-list-view view-without-leftbar">
                    ...
                    <div class="tabs unselectable">
                        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                            <ul class="layui-tab-title">
                                ...
                                <li class="layui-this"><a href="krJpSongList.jsp">日韩</a></li>
                ...
                <div>
                    <div class="list-container">
                        <div class="adaptive-list" id="my-song-list-rnb-row" style="opacity: 1">
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function getInfo(){
        $.ajax({
            url: "${pageContext.request.contextPath}/manageSongListByStyle.do?style=" + '日韩',
            dataType: "json",
            type: "post",
            async: false,
            data: {
    ...
    function successFu(pager){
        ...
        $("#my-song-list-rnb-row").html(html);
    }
    function  toPage() {
