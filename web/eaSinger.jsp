        ...
        <div class="content-wrapper">
            <div class="list-view artist-list-view view-without-leftbar">
                    ...
                    <div class="tabs unselectable">
                        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                            <ul class="layui-tab-title">
                                ...
                                <li class="layui-this"><a href="eaSinger.jsp">欧美</a></li>
                                <li><a href="krSinger.jsp">韩国</a></li>
                                <li><a href="jpSinger.jsp">日本</a></li>
                            </ul>
                ...
                <div class="list-container artist-list">
                    <div class="adaptive-list" id="my-singer-ea" style="opacity: 1">
                    </div>
                </div>
...
<script>
    ...
    function getInfo(){
        $.ajax({
            url: "${pageContext.request.contextPath}/manageSingerByClassify.do?cId="+'3',
            dataType: "json",
            type: "post",
            async: false,
            data: {
