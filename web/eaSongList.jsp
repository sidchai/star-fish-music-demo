            ...
            <div class="list-view artist-list-view view-without-leftbar">
                    ...
                    <div class="tabs unselectable">
                        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                            <ul class="layui-tab-title">
                                ...
                                <li class="layui-this"><a href="eaSongList.jsp">欧美</a></li>
                ...
                <div>
                    <div class="list-container">
                        <div class="adaptive-list" id="my-song-list-soft-row" style="opacity: 1">
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function getInfo(){
        $.ajax({
            url: "${pageContext.request.contextPath}/manageSongListByStyle.do?style=" + '欧美',
            dataType: "json",
            type: "post",
            async: false,
            data: {
    ...
    function successFu(pager){
        ...
        $("#my-song-list-soft-row").html(html);
    }
    function  toPage() {
