        ...
        <div class="content-wrapper">
            <div class="list-view artist-list-view view-without-leftbar">
                    ...
                    <div class="tabs unselectable">
                        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                            <ul class="layui-tab-title">
                                ...
                                <li class="layui-this"><a href="cnSinger.jsp">华语</a></li>
                ...
                <div class="list-container artist-list">
                    <div class="adaptive-list" id="my-singer-cn" style="opacity: 1">
                    </div>
                </div>
...
<script>
    ...
    function getInfo(){
        $.ajax({
            url: "${pageContext.request.contextPath}/manageSingerByClassify.do?cId=" + '2',
            dataType: "json",
            type: "post",
            async: false,
            data: {
