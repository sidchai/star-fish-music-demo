...
@MultipartConfig
@WebServlet("/addSongListInfo.am")
public class AddSongListInfoServlet extends HttpServlet {
    private SongListServer songListServer;

    public AddSongListInfoServlet() {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            //插入数据库
            songListServer.addSongListInfo(songList);
            //跳回主页
