...
@WebServlet("/manageSongList.do")
public class ManageSongListServlet extends HttpServlet {
    private SongListServer songListServer;

    public ManageSongListServlet() {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<SongList> songLists = songListServer.selectSongListInfo(Integer.parseInt(page),Integer.parseInt(limit),style);
        ...
        songListPage.setData(songLists);
        songListPage.setCount(songListServer.getSongListInfoCount(style));
